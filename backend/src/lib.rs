...
pub fn configure_api(config: &mut web::ServiceConfig) {
    config.service(
        web::scope("/api/v1")
            ...
            .service(routes::instruments::list)
            .service(routes::instruments::get)
            .service(routes::instruments::coverage)
            ...
            .service(routes::providers::provider_statuses)
            .service(routes::saved_searches::list_saved_searches)
            .service(routes::saved_searches::create_saved_search)
            .service(routes::saved_searches::update_saved_search)
            .service(routes::saved_searches::delete_saved_search)
